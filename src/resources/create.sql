...
INSERT INTO student (sid, pwd, name, department, status, phone) VALUES
                                                                    (2022078020, 'password1', '김지유', '소프트웨어학부', '재학', '01000000000'),
                                                                    (2020039010, 'password2', '홍길동', '소프트웨어학과', '재학', '01000010001'),
                                                                    (2021050010, 'password3', '박수현', '소프트웨어학부', '재학', '01000020002'),
                                                                    (2021089011, 'password4', '이정우', '소프트웨어학과', '재학', '01000030003'),
                                                                    (2021092010, 'password5', '김민지', '소프트웨어학부', '재학', '01000040004'),
                                                                    (2022011020, 'password6', '최지훈', '소프트웨어학부', '재학', '01000050005'),
                                                                    (2021075020, 'password7', '박지민', '소프트웨어학부', '재학', '01000060006'),
                                                                    (2020038011, 'password8', '오유정', '소프트웨어학과', '재학', '01000070007'),
                                                                    (2022078012, 'password9', '정수현', '컴퓨터공학과', '재학', '01000080008'),
                                                                    (2020089010, 'password10', '김하윤', '국제경영학과', '재학', '01000090009');

INSERT INTO professor (pid, pwd, name, department, phone) VALUES
                                                              (101, 'profpass1', '노서영', '소프트웨어학부', '01011112222'),
                                                              (102, 'profpass2', '홍장의', '소프트웨어학부', '01011122222'),
                                                              (103, 'profpass3', '이건명', '소프트웨어학부', '01011132223'),
                                                              (104, 'profpass4', '이의종', '소프트웨어학부', '01011142224'),
                                                              (105, 'profpass5', '이재성', '소프트웨어학부', '01011152225'),
                                                              (106, 'profpass6', '조오현', '소프트웨어학부', '01011162226'),
                                                              (107, 'profpass7', '이종연', '소프트웨어학부', '01011172227'),
                                                              (108, 'profpass8', '최경주', '소프트웨어학부', '01011182228'),
                                                              (109, 'profpass9', '정지훈', '소프트웨어학부', '01011192229'),
                                                              (110, 'profpass10', '강윤석', '소프트웨어학부', '01011202230');

INSERT INTO assistant (aid, pwd, name, department, phone) VALUES
                                                              (39101, 'asspass1', '김민재', '소프트웨어학부', '01077778888'),
                                                              (39102, 'asspass2', '이지은', '소프트웨어학부', '01077788889'),
                                                              (39103, 'asspass3', '박재훈', '소프트웨어학부', '01077798890');
