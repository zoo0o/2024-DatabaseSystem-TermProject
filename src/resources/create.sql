...
INSERT INTO document (did, title, type, content, submit_cid, submit_date, approve_aid, approve_date, is_approved) VALUES
                                                                                                                      (1, '알고리즘 스터디 계획', '계획서', '알고리즘 스터디 방향과 목표에 대한 계획입니다.', 1, '2024-01-20', 39101, '2024-01-25', TRUE),
                                                                                                                      (2, '네스트넷 회의록', '회의록', '네스트넷의 첫 번째 정기 회의 내용입니다.', 1, '2024-01-22', 39101, '2024-01-30', TRUE),
                                                                                                                      (3, 'PDA 회원 명단', '명단', 'PDA의 회원 명단입니다.', 3, '2024-01-25', 39103, '2024-01-28', TRUE),
                                                                                                                      (4, '네스트넷 프로젝트 계획', '계획서', '네스트넷의 2024년 프로젝트 계획입니다.', 1, '2024-02-10', NULL, NULL, FALSE),
                                                                                                                      (5, '네스트넷 회의록', '회의록', '네스트넷의 두 번째 정기 회의 내용입니다.', 1, '2024-02-15', 39101, '2024-02-20', TRUE),
                                                                                                                      (6, '네스트넷 회원 명단', '명단', '네스트넷의 회원 명단입니다.', 1, '2024-02-20', 39102, '2024-02-25', TRUE),
                                                                                                                      (7, '엠시스 프로젝트 보고서', '계획서', '엠시스의 프로젝트 진행 보고 내용입니다.', 7, '2024-03-01', NULL, NULL, FALSE),
                                                                                                                      (8, '빈즈 정기 회의록', '회의록', '빈즈의 정기 회의 내용을 기록한 문서입니다.', 8, '2024-03-05', 39103, '2024-03-10', TRUE),
                                                                                                                      (9, '축구 경기 일정', '명단', '축구의 경기 일정입니다.', 9, '2024-03-10', 39101, '2024-03-15', TRUE),
                                                                                                                      (10, '농구 팀 구성 명단', '명단', '농구의 팀 구성 명단입니다.', 10, '2024-03-15', NULL, NULL, FALSE);
